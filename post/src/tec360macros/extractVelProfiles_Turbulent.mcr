...
$!LINEARINTERPOLATE 
  SOURCEZONES =  [1]
  DESTINATIONZONE = 6
  # Varlist = [14:Pressure, 16:Total Pressure, 47:X Wall Shear, 54:U, 55:V]
  VARLIST =  [14,16,47,54-55]
  LINEARINTERPCONST = 0
  LINEARINTERPMODE = DONTCHANGE
$!EXTENDEDCOMMAND 
  COMMANDPROCESSORID = 'excsv'
  # turbulent case:
  COMMAND = 'VarNames:FrOp=1:ZnCount=1:ZnList=[6]:VarCount=7:VarList=[1-2,14,16,47,54-55]:ValSep=",":FNAME="CSVFILENAMEPATH/CSVFILENAME.csv"'
$!RemoveVar |MFBD|
