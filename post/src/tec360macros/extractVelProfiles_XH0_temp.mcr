...
$!CREATERECTANGULARZONE 
  ...
  Y2 = 0.050
  Z2 = 0
$!RENAMEDATASETZONE ZONE = 6 NAME = 'XH0'
$!LINEARINTERPOLATE 
  SOURCEZONES =  [1]
  DESTINATIONZONE = 6
...
$!EXTENDEDCOMMAND 
  ...
  # laminar case:
  COMMAND = 'VarNames:FrOp=1:ZnCount=1:ZnList=[6]:VarCount=7:VarList=[1-2,14,16,41,44-45]:ValSep=",":FNAME="/home/ws/ht72/Projekte/Forschungsprojekte/BackwardFacingStep2/cfx/500_pocket/test/post/XH0.csv"'
$!RemoveVar |MFBD|
